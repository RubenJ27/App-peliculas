...
export const Results = (movies) => {
  ...
  movies = getMovies;
   ...
   const obtainMovies = async () => {
    try {
      const response = await BASE_URL_AUTOCOMPLETE.get(`/?q=${title}`, { headers: { "X-RapidAPI-Key": import.meta.PROD.VITE_APP_API_KEY, "X-RapidAPI-Host": import.meta.PROD.VITE_APP_API_HOST} });
