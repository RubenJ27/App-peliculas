...
const ResultListItems = ({id, title, imageURL}) => {
  return (
    <div key={id} className="flex flex-row w-full mt-10" style={{ minWidth: 650 }}>
            ...
            <div className='flex h-full items-end'>
              <button className="border-2 border-special-red rounded-md w-36 h-10 text-xl text-special-red hover:bg-red-400 hover:text-white">Ver mas</button>
              </div>
